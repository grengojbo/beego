...
func date(t time.Time) string {
	return beego.Date(t, beego.AppConfig.String("DateFormat"))
}

func datetime(t time.Time) string {
	return beego.Date(t, beego.AppConfig.String("DateTimeFormat"))
}

func datetimes(t time.Time) string {
	return beego.Date(t, beego.AppConfig.String("DateTimeShortFormat"))
}
...
func loginto(uris ...string) template.HTMLAttr {
	...
	to := fmt.Sprintf("%slogin", beego.AppConfig.String("AppUrl"))
	if len(uri) > 0 {
